...
sliderBannerEntityFromJson(SliderBannerEntity data, Map<String, dynamic> json) {
	if (json['id'] != null) {
		data.id = json['id'] is String
				? int.tryParse(json['id'])
				: json['id'].toInt();
	}
	if (json['slider_title'] != null) {
		data.sliderTitle = json['slider_title'].toString();
	}
...
Map<String, dynamic> sliderBannerEntityToJson(SliderBannerEntity entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
	data['slider_title'] = entity.sliderTitle;
