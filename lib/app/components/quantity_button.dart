...
class QuantityButton extends StatefulWidget {
  ...
  QuantityButton(this.initialQuantity,
      {this.onAdd, this.onDelete, this.onRemove, this.max, this.crossAxisAlignment});
                  ...
                  child: Padding(
                    ...
                    child: Icon(
                        ...
                        color: currentQty == 1
                            ...
                            : AppColors.neutralDark,  size: 18,),
                  ))),
          SizedBox(
            width: 36,
            child: Padding(
              padding: const EdgeInsets.all(8.0),
              child: Center(child: Text(currentQty.toString(), style: bodyTextNormal1.copyWith(color : AppColors.neutralGray),)),
            ),
          ),
          InkWell(
              onTap: () {
